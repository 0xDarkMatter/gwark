...
def batch_summarize_emails(emails: List[Dict], api_key: str = None, batch_size: int = 10) -> List[Dict]:
    ...
    for i in range(0, len(emails), batch_size):
        ...
        try:
            ...
            for line in response_text.split('\n'):
                ...
                stripped = line.strip()
                is_email_marker = ('Email ' in stripped and ':' in stripped and
...
def test_summarization():
    ...
    # Test
    summarized = batch_summarize_emails(sample_emails)
